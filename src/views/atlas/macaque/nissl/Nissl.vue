    ...
    <template #left>
      <el-scrollbar max-height="calc(100vh-150px)" class="thumbnail">
        <div
          ...
          :class="[
            'thumbnail-item',
            { 'thumbnail-item-active': nissl === showNissl },
          ]"
        ...
        >
          <div class="thumbnail-item-title">
            <span class="thumbnail-item-title-seq">{{
              `${index + 1}/${nisslList.length}`
            }}</span>
      ...
      <div class="right-panel">
        ...
        <bs-widgets header="Render Datas">
          <div class="between-flex">
            ...
            <el-switch
              v-model="showRegion"
              @change="(val) => handleLayerVisible('region', val)"
            />
          </div>
          <div class="between-flex">
            ...
            <el-switch
              v-model="showImage"
              @change="(val) => handleLayerVisible('image', val)"
            />
          </div>
        </bs-widgets>
