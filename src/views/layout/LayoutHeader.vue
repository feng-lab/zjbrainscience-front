<template>
  <div class="header-content">
    <div class="header-content--left">
      <el-icon @click="toggleCollapse" class="header-icon hidden-md-and-down">
        <component :is="isCollapse ? 'Expand' : 'Fold'" />
      </el-icon>
      <el-icon @click="toggleDrawer" class="header-icon hidden-md-and-up">
        <bs-icon-menu />
      </el-icon>
    </div>
          ...
          <!-- <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item icon="postcard">
                <el-tooltip
                  :content="$t('label.changeAccessLevel')"
                  placement="top"
                >
                  <el-tag>{{ $t(`auth.${user.access_level}`) }}</el-tag>
                </el-tooltip>
              </el-dropdown-item>
              <el-dropdown-item icon="lock" @click="goToPassword" divided>{{
                $t('menus.password')
              }}</el-dropdown-item>
              <el-dropdown-item
                icon="switch-button"
                @click="() => doLogout(false)"
                >{{ $t('button.logout') }}</el-dropdown-item
              >
            </el-dropdown-menu>
          </template> -->
        </el-dropdown>
